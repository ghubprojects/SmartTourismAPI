...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartTourismAPI.WebApi.DbModels.MFile", b =>
                {
            ...
            modelBuilder.Entity("SmartTourismAPI.WebApi.DbModels.MPlaceDetail", b =>
                {
            ...
            modelBuilder.Entity("SmartTourismAPI.WebApi.DbModels.MPlaceType", b =>
                {
            ...
            modelBuilder.Entity("SmartTourismAPI.WebApi.DbModels.MUser", b =>
                {
            ...
            modelBuilder.Entity("SmartTourismAPI.WebApi.DbModels.TPlacePhoto", b =>
                {
            ...
            modelBuilder.Entity("SmartTourismAPI.WebApi.DbModels.TPlaceReview", b =>
                {
            ...
            modelBuilder.Entity("SmartTourismAPI.WebApi.DbModels.MUser", b =>
                {
                    b.HasOne("SmartTourismAPI.WebApi.DbModels.MFile", "Avatar")
                        .WithMany("MUsers")
            ...
            modelBuilder.Entity("SmartTourismAPI.WebApi.DbModels.TPlacePhoto", b =>
                {
                    b.HasOne("SmartTourismAPI.WebApi.DbModels.MPlaceDetail", "Detail")
                        .WithMany("TPlacePhotos")
                        .HasForeignKey("DetailId")
                        .IsRequired()
                        .HasConstraintName("t_place_photo_m_place_detail_fk");

                    b.HasOne("SmartTourismAPI.WebApi.DbModels.MFile", "File")
                        .WithMany("TPlacePhotos")
            ...
            modelBuilder.Entity("SmartTourismAPI.WebApi.DbModels.TPlaceReview", b =>
                {
                    ...
                    b.HasOne("SmartTourismAPI.WebApi.DbModels.MUser", "User")
                        .WithMany("TPlaceReviews")
